...
Modalbox.Methods = {
	...
	options: {
		...
		overlayOpacity: 0.45, // Default overlay opacity
		overlayDuration: 0.2, // Default overlay fade in/out duration in seconds
		...
		closeValue: "Cerrar ventana", // Default string for close link in the header
		params: {},
