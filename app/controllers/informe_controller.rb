class InformeController < ApplicationController
  ...
  def listado
    ...
    if params[:informe]
      ...
      fecha_inicio = Date.strptime(params[:informe][:fecha_inicio], "%d.%m.%Y") if params[:informe][:fecha_inicio] && params[:informe][:fecha_inicio] != ""
      fecha_fin = Date.strptime(params[:informe][:fecha_fin], "%d.%m.%Y") if params[:informe][:fecha_fin] && params[:informe][:fecha_fin] != ""
